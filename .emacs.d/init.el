...
;; deal with  cl package deprication
...
;;  (require 'ox-confluence)
  ;;  (require 'ol-man)
  (load (expand-file-name "ox-confluence.el" user-emacs-directory))
...
(use-package rust-mode
  :mode "\\.rs\\'"
  :init   (if (not (string-match-p (regexp-quote "nightly") (shell-command-to-string "rustc --version")))
